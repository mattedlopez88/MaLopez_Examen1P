...
namespace MaLopez_Examen1P.Controllers
{
    public class ML_modelo1Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MLNombre,MLEdad,MLDireccion,MLDepartamento,MLFechaNacimiento,MLIsCliente,MLSaldo")] ML_modelo1 mL_modelo1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MLNombre,MLEdad,MLDireccion,MLDepartamento,MLFechaNacimiento,MLIsCliente,MLSaldo")] ML_modelo1 mL_modelo1)
        {
            if (id != mL_modelo1.Id)
            {
                return NotFound();
